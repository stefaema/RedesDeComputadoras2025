...
- En un momento se modificó la ip de la PC2 a 192.168.1.10 para acoplarnos mejor a una futura refactorización de direcciones que no pudimos concretar. Es por ello que se puede visualizar esa dirección en las capturas siguientes en la parte Inter-Grupo.
